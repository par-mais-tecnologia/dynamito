...
Finder.prototype.executePrivate = function () {
  return new Promise((resolve, reject) => {
    ...
    if (this.data.ProjectionExpression !== undefined) {
      queryParams.ProjectionExpression = this.data.ProjectionExpression;
    }

    // Expression Attribute Names
    if (this.data.ExpressionAttributeNames !== undefined) {
      queryParams.ExpressionAttributeNames = this.data.ExpressionAttributeNames;
    }
